...
latlng.lat+","+latlng.lng+"););out;>;";return overpass_query},getData:function(queryString,action){this._pendingRequest=true;var url="https://overpass-api.de/api/interpreter?data="+encodeURIComponent(queryString)+"&callback=?";this.ajax(url,function(xmlhttp){this._pendingRequest=false;var json=JSON.parse(xmlhttp.responseText);action(json)})},ajax:function(xmldocpath,completecallback,errorcallback){var xmlhttp=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");xmlhttp.onreadystatechange=
